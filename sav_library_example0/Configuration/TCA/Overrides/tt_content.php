...
$GLOBALS['TCA']['tt_content']['types']['list']['subtypes_excludelist']['sav_library_example0_pi1'] = 'layout,select_key';

// Adds the flexform field to plugin option
$GLOBALS['TCA']['tt_content']['types']['list']['subtypes_addlist']['sav_library_example0_pi1'] = 'pi_flexform';
