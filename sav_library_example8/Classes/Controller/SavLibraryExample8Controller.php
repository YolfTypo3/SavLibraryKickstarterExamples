 ...
 * @package savlibraryexample8
 */
class tx_savlibraryexample8_pi1 extends \TYPO3\CMS\Frontend\Plugin\AbstractPlugin {
	 ...
	 * @var string
	 */
	public $scriptRelPath = 'Classes/Controller/SavLibraryExample8Controller.php';
