...
if (TYPO3_MODE === 'BE') {
  ...
  '
    ...
    foreach ($contextSensitiveHelpFiles as $contextSensitiveHelpFileKey => $contextSensitiveHelpFile) {
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('xEXT_sav_library_kickstarter_' . $contextSensitiveHelpFileKey, 'EXT:sav_library_kickstarter/Resources/Private/Language/ContextSensitiveHelp/' . $contextSensitiveHelpFile . '.xlf');
    }
}
?>
