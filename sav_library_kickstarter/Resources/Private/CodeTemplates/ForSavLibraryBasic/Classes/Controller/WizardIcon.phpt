...
class {controllerName}WizardIcon {
	...
	public function proc(array $wizardItems) {
		...
		$wizardItems['plugins_tx_{extensionName->sav:tolower()}_{controllerName->sav:tolower()}'] = array(
			'icon'        => ExtensionManagementUtility::extRelPath('{extension.general.1.extensionKey}') . 'Resources/Private/Icons/icon_{extension.general.1.extensionKey->sav:function(name:"removeUnderscore")}.png',
