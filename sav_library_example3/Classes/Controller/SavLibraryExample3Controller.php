 ...
 * @package savlibraryexample3
 */
class tx_savlibraryexample3_pi1 extends \TYPO3\CMS\Frontend\Plugin\AbstractPlugin {
	 ...
	 * @var string
	 */
	public $prefixId = 'tx_savlibraryexample3_pi1';
	 ...
	 * @var string
	 */
	public $scriptRelPath = 'Classes/Controller/SavLibraryExample3Controller.php';
