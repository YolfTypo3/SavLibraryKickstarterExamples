...
Each filter is defined by means of a default FLUID template in the extension folder Resources/Private/Default. 
The default root paths can be changed by modifying the following *constants* in TypoScript.
