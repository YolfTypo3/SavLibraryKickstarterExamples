...
/**
 * Plugin 'SAV Library Example1 - Contact list' for the 'sav_library_example1' extension.
 *
 * @author Laurent Foulloy <yolf.typo3@orange.fr>
 * @package savlibraryexample1
 */
class tx_savlibraryexample1_pi1 extends \TYPO3\CMS\Frontend\Plugin\AbstractPlugin {
	 ...
	 * @var string
	 */
	public $prefixId = 'tx_savlibraryexample1_pi1';
	 ...
	 * @var string
	 */
	public $scriptRelPath = 'Classes/Controller/SavLibraryExample1Controller.php';
	 ...
	 * @var string
	 */
	public $extKey = 'sav_library_example1';
