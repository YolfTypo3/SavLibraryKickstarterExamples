...
if ($typo3Version->getMajorVersion() == 13) {
	...
	ExtensionManagementUtility::addPlugin(
	    [
	        'label' => 'LLL:EXT:sav_library_example1/Resources/Private/Language/locallang_db.xlf:tt_content.list_type_pi1',
	        'value' => 'sav_library_example1_pi1',
	        'icon'	=> 'ext-savlibraryexample1-wizard',
	        'group'	=> 'plugins'
	    ],
	    'CType',
