...
/**
 * Plugin 'SAV Library Example4 - CD Album (Improved)' for the 'sav_library_example4' extension.
 *
 * @author Laurent Foulloy <yolf.typo3@orange.fr>
 * @package savlibraryexample4
 */
class tx_savlibraryexample4_pi1 extends \TYPO3\CMS\Frontend\Plugin\AbstractPlugin {
	 ...
	 * @var string
	 */
	public $prefixId = 'tx_savlibraryexample4_pi1';
	 ...
	 * @var string
	 */
	public $scriptRelPath = 'Classes/Controller/SavLibraryExample4Controller.php';
	 ...
	 * @var string
	 */
	public $extKey = 'sav_library_example4';
