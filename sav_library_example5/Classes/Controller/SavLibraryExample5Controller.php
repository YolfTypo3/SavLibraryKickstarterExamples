...
namespace YolfTypo3\SavLibraryExample5\Controller;
...
/**
 * Plugin 'SAV Library Example5 - Hooks' for the 'sav_library_example5' extension.
 *
 * @author Laurent Foulloy <yolf.typo3@orange.fr>
 * @package sav_library_example5
 */
class SavLibraryExample5Controller extends \TYPO3\CMS\Frontend\Plugin\AbstractPlugin 
{
	/**
	 * PrefixId
	 * @var string
	 */
	public $prefixId = 'tx_savlibraryexample5_pi1';

	/**
	 * Extension key
	 * @var string
	 */
	public $extKey = 'sav_library_example5';
