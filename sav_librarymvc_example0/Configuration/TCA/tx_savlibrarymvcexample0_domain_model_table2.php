...
return array(
    'ctrl' => array(
        ...
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'default_sortby' => 'ORDER BY tx_savlibrarymvcexample0_domain_model_table2.field1 ',
        'delete' => 'deleted',
        'enablecolumns' => array(
            'disabled' => 'hidden',
        ),
        'iconfile' => 'EXT:sav_librarymvc_example0/Resources/Private/Icons/icon_tx_savlibrarymvcexample0_domain_model_table2.gif',
        'EXT' => array(
